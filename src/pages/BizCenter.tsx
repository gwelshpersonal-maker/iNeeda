...
export const BizCenter = () => {
  ...
  const [activeTab, setActiveTab] = useState<'settlements' | 'staffing' | 'info'>('settlements');
    ...
    <div className="space-y-6 animate-in fade-in">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
           ...
           <p className="text-slate-500 mt-1">Manage your business finances, staffing, and resources.</p>
        </div>
      </div>
