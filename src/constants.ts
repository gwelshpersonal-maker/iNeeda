...
export const ALL_SERVICE_CATEGORIES: ServiceCategory[] = [
    'LANDSCAPING', 'MOVING', 'CLEANING', 'HANDYMAN', 'PLUMBING', 'AUTO', 'AUTO_DETAILING', 'CONSTRUCTION', 'COMPUTER', 'GENERAL_LABOR', 'JOBSITE_LABOR', 'POWER_WASHING', 'SMART_HOME_INSTALL', 'PEST_CONTROL', 'WEB_APP_DEV', 'FURNITURE_ASSEMBLY', 'GUTTER_CLEANING', 'LISTING_TOUCH_UP', 'JUNK_REMOVAL'
];

export const AVAILABLE_SERVICE_CATEGORIES: ServiceCategory[] = [
    'MOVING', 'CLEANING', 'HANDYMAN', 'PLUMBING', 'LANDSCAPING', 'POWER_WASHING', 'GENERAL_LABOR', 'JOBSITE_LABOR', 'AUTO', 'AUTO_DETAILING', 'COMPUTER', 'SMART_HOME_INSTALL', 'PEST_CONTROL', 'WEB_APP_DEV', 'FURNITURE_ASSEMBLY', 'GUTTER_CLEANING', 'LISTING_TOUCH_UP', 'JUNK_REMOVAL'
];
...
export const SERVICE_CATEGORIES = {
  ...
  JUNK_REMOVAL: { risk: 'MEDIUM', fee: 5.00 },
...
export const CATEGORY_RISK_MAPPING: Record<ServiceCategory, { risk: keyof typeof RISK_LEVELS }> = {
  ...
  JUNK_REMOVAL: { risk: RISK_LEVELS.MEDIUM },
